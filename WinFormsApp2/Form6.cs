...
namespace WinFormsApp2
{
    ...
    {
        private const int QuestionIndex = 3; // ข้อ 4
        ...
        public Form6()
        {
            ...
            radioButton1.CheckedChanged += radioButton1_CheckedChanged; // A=E
            radioButton2.CheckedChanged += radioButton2_CheckedChanged; // B=I
        ...
        {
            var prev = new Form5 { Owner = this.Owner };
            this.Hide();
            prev.Show();
        ...
        private void button2_Click(object? sender, EventArgs e)
        {
            ...
            var next = new Form7 { Owner = this.Owner };
            this.Hide();
            next.Show();
